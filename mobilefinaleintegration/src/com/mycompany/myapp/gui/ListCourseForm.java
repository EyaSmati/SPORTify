       ...
       Picker  DATE = new Picker ();
        ...
        TextField tfPlaceDisponible1= new TextField("", "PlaceDisponible");
         ...
         Label a=new Label("    ");
                 ...
                 fmodifier. addAll(cmb_id,tfheure1,cmb_type1,tfduree1,DATE,cmb_mailCoach,cmb_nomS,tfPlaceDisponible1);
                ...
                cnreq.setPost(false);
                String data = "ID Cours : " + cmb_id.getSelectedItem().toString() + " Type : " +cmb_type1.getSelectedItem().toString()  + "Date :" + dated + " Heure : " + tfheure1.getText() + "Duree : " + tfduree1.getText() +"MailCoach : " + cmb_mailCoach.getSelectedItem().toString() +"PlaceDisponible : " + tfPlaceDisponible1.getText() + "Merci pour votre confiance &#128525;";
                ...
                cnreq.addResponseListener(evx
                     ...
                     String Image = new String(cnreq.getResponseData());
                      Cours c1 = new Cours(cmb_id.getSelectedItem().toString(),cmb_type1.getSelectedItem().toString(),dated,Integer.parseInt(tfheure1.getText()),Integer.parseInt(tfduree1.getText()),cmb_mailCoach.getSelectedItem().toString(),cmb_nomS.getSelectedItem().toString(),Integer.parseInt(tfPlaceDisponible1.getText()),Image);
