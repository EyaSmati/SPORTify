        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
               if ((tfId.getText().length()==0)||(tfLibelle.getText().length()==0)||(tfQuantite.getText().length()==0)||(tfPrix.getText().length()==0))
                ...
                {
                    try {
                        Produits p = new Produits(Integer.parseInt(tfId.getText()),tfLibelle.getText(),Integer.parseInt(tfQuantite.getText()),Integer.parseInt(tfPrix.getText()),cmb_type.getSelectedItem().toString());                       
