        ...
        TextField tfImage= new TextField("", "Image");
         Label a=new Label("    ");
            ...
            Supprimer.addActionListener(sup
                ...
                Label supp = new Label("SUPPRIMER CATEGORIES");
        supp.setUIID("login");
...
fsupprimer.add(supp);
                ...
                submit.setUIID("vtnvalid");
                TextField tfId = new TextField("","idcategorie");
         ...
         Label a=new Label("    ");
                ...
                submit.addActionListener(sub
                    ...
                    int id1=Integer.parseInt(tfId.getText());
                        if( ServiceCategorieProduit.getInstance().deleteCategorieProduit(id1))
                            Dialog.show("Success","Categorie Produit Supprimé",new Command("OK"));
                        else
                            Dialog.show("ERROR", "Server error", new Command("OK"));
                    new ListCategorieProduitForm(this).show();
