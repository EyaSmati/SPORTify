...
public class Utilisateur {
    ...
    public Utilisateur(String surnom, String prenom, String nom, String numeroDeTelephone, String email, String password, String dateDeNaissance, String sexe, String role) {
        ...
        if ((!MailValidation.isValidEmail(email)) && ((sexe.equals("Homme"))||(sexe.equals("Femme"))) && ((role.equals("Client"))||(role.equals("Coach"))||(role.equals("Proprietaire salle de sport")))){
            this.surnom = surnom;
            this.prenom = prenom;
            this.nom = nom;
        ...
        if (!(role.equals("Client"))&& !(role.equals("Coach"))&&!(role.equals("Proprietaire salle de sport")))
