        ...
        ;
         Label a=new Label("    ");
                ...
                fmodifier.getToolbar().setUIID("tb");
                 fmodifier.addAll(tfIdSalle,tfNomSalle,tfAdresse,cmb_Region1,tfHdebut,tfHfin,tfMin,tfNumtel);
                ...
                submit.addActionListener(sub
                        -> {
                    Salledesport salle = new Salledesport(tfIdSalle.getText(),tfNomSalle.getText(),tfAdresse.getText(),cmb_Region1.getSelectedItem().toString(),Integer.parseInt(tfHdebut.getText()),Integer.parseInt(tfHfin.getText()),Integer.parseInt(tfMin.getText()),Integer.parseInt(tfNumtel.getText()));
