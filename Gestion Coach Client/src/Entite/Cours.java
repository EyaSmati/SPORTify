...
public class Cours {
    ...
    public Cours(int ID_Cours,String Type_Cours, String Date, String Heure, String Duree, int Place_Disponible) {
    ...
    public Cours(int ID_Cours,String Type_Cours, String Date, String Heure, String Duree, String MailCoach, int Place_Disponible) {
        this.ID_Cours = ID_Cours;
        this.Type_Cours = Type_Cours;
        this.Date = Date;
        this.Heure = Heure;
    ...
    public Cours(int ID_Cours, int Place_Disponible) {
        this.ID_Cours = ID_Cours;
        this.Place_Disponible = Place_Disponible;
    }
