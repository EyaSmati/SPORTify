        ...
        TextField tfImage= new TextField("", "Image");
         Label a=new Label("    ");
                ...
                fmodifier.getToolbar().setUIID("tb");
                 fmodifier.addAll(tfId,tfDescription,tfType,tfImage);
                ...
                submit.addActionListener(sub
                        -> {
                    Categorie t = new Categorie(tfType.getText(),tfDescription.getText(),tfImage.getText(),Integer.parseInt(tfId.getText()));
