...
ComboBox cmb_type1 = new ComboBox();
         ...
         Label a=new Label("    ");
                ...
                submit.addActionListener(sub
                        -> {
                    Produits p1 = new Produits(tfIdProduit.getText(),tfLibelleProduit.getText(),cmb_type1.getSelectedItem().toString(),Integer.parseInt(tfQuantiteProduit.getText()),Integer.parseInt(tfPrix.getText()));
            ...
            Supprimer.addActionListener(sup
                    -> {
                new ServiceProduits().DeleteProduits(p.getId());
