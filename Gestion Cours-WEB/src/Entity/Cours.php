...
class Cours
{
     ...
     *@Assert\NotBlank(message="Place_Disponible is required")
     * @Assert\Range(
     *      min = 0,
     *      max = 30,
     *      notInRangeMessage = "It must be between {{ min }}h and {{ max }}h",
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="MailCoach", referencedColumnName="email")
     * })
     *   *@Assert\NotBlank(message="Mail Coach is required")
     */
    private $mailcoach;
     ...
     * @return Utilisateur
     */
    public function getMailcoach(): ?Utilisateur
    {
        return $this->mailcoach;
    }

    /**
     * @param \App\Entity\Utilisateur $mailcoach
     */
    public function setMailcoach(?Utilisateur $mailcoach): self
    {
