...
public class SalleDeSport {
    ...
    public SalleDeSport(int Id_Salle, String Nom_Salle, String Adresse,String Region,int HDebut,int HFin,int Min,int NumTel) {
    ...
    public SalleDeSport(int Id_Salle, String Nom_Salle) {
       this.Id_Salle = Id_Salle;
       this.Nom_Salle = Nom_Salle;
    }
